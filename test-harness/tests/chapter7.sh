#!/bin/bash
# Smoke test for Chapter 7 - Weather Events API with Observability
#
# This is the same API as chapter5-api but with X-Ray tracing and CloudWatch
# metrics/alarms. The test verifies the API endpoints work correctly.

set -e

source harnessShared.sh

log_info "Testing Chapter 7 - Weather Events API with Observability"
...
log_info "Chapter 7 test passed"
